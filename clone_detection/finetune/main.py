            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.save_steps > 0 and global_step % args.save_steps == 0:
                    ...
                    if results["eval_f1"] >= best_f1:
                        ...
                        output_dir = os.path.join(output_dir, "{}".format("finetune_teacher_model.bin"))
...
def evaluate(args, model, tokenizer, eval_when_training=False):
    ...
    if "unlabel_train" in args.eval_data_file:
        np.save("preds_unlabel_train", logits)
...
def main():
    ...
    parser.add_argument("--epoch", type=int, default=42, help="epoch for training")
    ...
    args.model_name = "microsoft/unixcoder-base"
